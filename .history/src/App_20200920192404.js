...
class App extends Component {
  ...
  onMessageReceive = (msg, topic) => {
    ...
    var date = Date.UTC(Number(this.state.msg_v.CreatedTime.substring(0,4)),Number(this.state.msg_v.CreatedTime.substring(5,7))-1,Number(this.state.msg_v.CreatedTime.substring(8,10))-1,
